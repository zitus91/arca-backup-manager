<div class="space-y-6">
                        ...
                        <tr class="border-b border-base-content/5 hover:bg-base-content/[0.02] transition-colors" wire:key="dest-{{ $destination->id }}">
                            ...
                            <td>
                                <div class="flex items-center justify-end gap-1">
                                    ...
                                    <button wire:click="confirmDelete({{ $destination->id }})" class="btn btn-ghost btn-xs btn-square rounded-lg text-error/70 hover:text-error hover:bg-error/10 tooltip tooltip-left" data-tip="{{ __('backup-storage-destination.delete') }}">
    ...
    <x-confirm-modal
        ...
        :message="__('backup-storage-destination.confirm_delete')"
    />
</div>
