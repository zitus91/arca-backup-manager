                            ...
                            <td>
                                <div class="flex justify-end gap-1">
                                    @if ($log->status === 'success' && $log->storage_path)
                                        <a href="{{ route('admin.backup.logs.download', $log) }}" class="btn btn-ghost btn-xs btn-square rounded-lg tooltip tooltip-left" data-tip="{{ __('backup-log.download') }}" target="_blank">
